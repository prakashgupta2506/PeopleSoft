...
public class AddToCart_PO {
	...
	public static void clickProductImageFromSearchResult(String item) throws InterruptedException {
		...
		String AddToCart_ProductImage_XPATH_REPLACED = AddToCart_ProductImage_XPATH.replace("ProductName", item);

		SeleniumUtil.clickWebElement(By.xpath(AddToCart_ProductImage_XPATH_REPLACED));
