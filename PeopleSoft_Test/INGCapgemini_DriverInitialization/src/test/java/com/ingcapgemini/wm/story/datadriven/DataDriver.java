...
public class DataDriver {
	...
	public void admin_user_and_password_is_logged_into_the_application(String username, String password) throws Throwable {
		...
		Assert.assertEquals("the page title is not matching",Login.LOGIN_PAGE_TITLE ,SeleniumUtil.getTitle());
	...
	public void user_fill_the_form_fields_and_and(String frst, String scnd, String thrd) throws Throwable {
		...
		SeleniumUtil.getWebElement( By.id("field1")).sendKeys(frst);
		SeleniumUtil.getWebElement( By.id("field2")).sendKeys(scnd);
		SeleniumUtil.getWebElement( By.id("field3")).sendKeys(thrd);
	}
	...
	public void verify_user_is_created(String arg1) throws Throwable {
	    ...
	    // Write code here that turns the phrase above into concrete actions
		SeleniumUtil.ValidateWebElementPresence(By.id("ValidationText"));//even if this fails it will go to next scenario..
