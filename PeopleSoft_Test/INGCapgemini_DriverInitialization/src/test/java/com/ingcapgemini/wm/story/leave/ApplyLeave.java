...
public class ApplyLeave {
	...
	public void user_apply_leave_for_date_from_to_with_leave_type_as_with_comments_as(String fromDate, String toDate, String leaveType, String comment) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
		 HomePage.clickLeaveApply();
		    SeleniumUtil.ValidateWebElementPresence(By.id(ApplyLeavePO.APPLYLEAVE__LEAVETYPE_ID));
		   ApplyLeavePO.applyLeave(leaveType, fromDate, toDate, comment);
		   SeleniumUtil.ValidateWebElementPresence(By.id(HomePage.HOME_PAGE_WELCOME_ID));
	}
	...
	public void user_cancels_the_leaves_from_to(String frmDate, String toDate) throws Throwable {
		...
		SeleniumUtil.getWebElement(By.xpath(HomePage.HOME_PAGE_LEAVE_LINK_XPATH)).click();
		
		SeleniumUtil.getWebElement(By.id(ApplyLeavePO.APPLYLEAVE__MYLEAVE_ID)).click();
		
		
		SeleniumUtil.selectItemWebTable(By.xpath(MyLeavePO.MYLEAVE_LEAVETABLE_XPATH), 0, 5, frmDate, "Pending Approval", "Cancel");
		SeleniumUtil.getWebElement(By.id(MyLeavePO.MYLEAVE_SAVE_ID)).click();
	...
	public void verify_cancellation_is_successful() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
		SeleniumUtil.ValidateWebElementPresence(By.xpath(MyLeavePO.MYLEAVE_CANCELLEDSTATUS_XPATH));
