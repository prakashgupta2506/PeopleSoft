...
public class HomePage {
	...
	public static void clickLeaveApply() throws Throwable{
		SeleniumUtil.getWebElement(By.xpath(HOME_PAGE_LEAVE_LINK_XPATH)).click();
		Thread.sleep(1000);
		SeleniumUtil.getWebElement(By.id(HOME_PAGE_APPLY_ID)).click();		
